...
export const clickVatBtn = (fixture: ComponentFixture<CounterpartyContractComponent>): void => {
...
export const clickNoVatBtn = (fixture: ComponentFixture<CounterpartyContractComponent>): void => {
    const vatBtn = fixture.debugElement.query(
...
export const clickSubmitButton = (fixture: ComponentFixture<CounterpartyContractComponent>): void => {
